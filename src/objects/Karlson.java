...
public class Karlson extends AbstractHuman implements JumpAble {
    ...
    public void doSomeThing(Action action, Verb_time time, Pot e){
        if (action == Action.Drop && time == Verb_time.Past)
            System.out.println(super.name + " хотел сбросить " + e.getName() + " на улицу");
